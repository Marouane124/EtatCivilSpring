...
@ComponentScan(basePackages = {"ma.projet.beans","ma.projet.dao","ma.projet.services"})
...
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("ma.projet.beans");  // Update with your entity package
